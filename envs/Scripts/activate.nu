...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Cristhian Zapata\Desktop\Cotizador\envs'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Cristhian Zapata\Desktop\Cotizador\envs\Scripts\deactivate.nu'
